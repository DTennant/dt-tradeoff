...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False, is_retrieval=False, augmentation='auto'):
    """
    cifar 100
    """
...
def get_cifar100_dataloaders_sample(batch_size=128, num_workers=8, k=4096, mode='exact',
                                    is_sample=True, percent=1.0, augmentation='none'):
    """
    cifar 100
    """
    data_folder = get_data_folder()
